...
import de.dh.apstest.ui.icons.Backup
import de.dh.apstest.ui.icons.Config_Outline
import de.dh.apstest.ui.icons.Restore
import de.dh.apstest.ui.icons.Theme_Light_Dark
...
fun IconCatalogPreview() {
    _root_ide_package_.de.dh.apstest.ui.theme.ApsTheme {
        Surface {
            LazyColumn(
